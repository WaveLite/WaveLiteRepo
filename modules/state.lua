...
local THEMES = {
	dark = {
		...
		BODY      = Color3.fromRGB(24,  24,  29),
		BORDER    = Color3.fromRGB(55,  55,  65),
		HIGHLIGHT = Color3.fromRGB(40,  40,  48),
		TEXT      = Color3.fromRGB(210, 210, 215),
		SUBTEXT   = Color3.fromRGB(130, 130, 140),
		CHECKBOX  = Color3.fromRGB(36,  36,  44),
		CB_HOVER  = Color3.fromRGB(48,  48,  58),
		CB_BORDER = Color3.fromRGB(70,  70,  85),
		MARK      = Color3.fromRGB(130, 200, 255),
		TRACK     = Color3.fromRGB(40,  40,  50),
		FILL      = Color3.fromRGB(100, 170, 255),
		KNOB      = Color3.fromRGB(180, 220, 255),
		VAL       = Color3.fromRGB(100, 170, 255),
	...
	light = {
		...
		HEADER    = Color3.fromRGB(225, 225, 232),
		PANEL     = Color3.fromRGB(250, 250, 255),
		BODY      = Color3.fromRGB(235, 235, 240),
		BORDER    = Color3.fromRGB(160, 160, 175),
		HIGHLIGHT = Color3.fromRGB(255, 255, 255),
		TEXT      = Color3.fromRGB(30,  30,  35),
		SUBTEXT   = Color3.fromRGB(100, 100, 110),
		CHECKBOX  = Color3.fromRGB(220, 220, 228),
		CB_HOVER  = Color3.fromRGB(200, 200, 210),
		CB_BORDER = Color3.fromRGB(130, 130, 150),
		MARK      = Color3.fromRGB(30,  100, 200),
		TRACK     = Color3.fromRGB(190, 190, 200),
		FILL      = Color3.fromRGB(60,  120, 210),
		KNOB      = Color3.fromRGB(20,  70,  160),
		VAL       = Color3.fromRGB(30,  100, 200),
...
local function applyTheme(themeName)
	...
	for _, entry in ipairs(themedObjects) do
		pcall(function() entry.obj[entry.prop] = T[entry.role] end)
	end
	for _, sd in ipairs(themedSliders) do
		pcall(function()
			sd.track.BackgroundColor3 = T.TRACK
			sd.fill.BackgroundColor3  = T.FILL
			sd.knob.BackgroundColor3  = T.KNOB
			sd.valueLabel.TextColor3  = T.VAL
		end)
	end
	for _, cd in ipairs(themedCheckboxes) do
		pcall(function()
			cd.box.BackgroundColor3 = T.CHECKBOX
			cd.box.BorderColor3     = T.CB_BORDER
			cd.mark.TextColor3      = T.MARK
		end)
	end
	for _, kb in ipairs(themedKeybinds) do
		pcall(function()
			kb.BackgroundColor3 = T.CHECKBOX
			kb.BorderColor3     = T.CB_BORDER
...
return {
	...
	THEMES           = THEMES,
	getT             = function() return T end,
	getThemeName     = function() return currentThemeName end,
